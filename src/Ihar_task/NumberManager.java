...
import static Ihar_task.Train.initArrayListT;
import static TaskThird.util.CollectionComparator.initArrayList;
...
public class NumberManager {
    public static void main(String[] args) {
        List<Integer> arrayList = initArrayListT();
        System.out.println(arrayList);
        Set<Integer> uniq = new HashSet<Integer>(arrayList);
...
////    private  double a,b;
////    NumberManager(double x, double y, double a, double b) {
////        super(x, y);
////        this.a=a;
////        this.b=b;
////    }
